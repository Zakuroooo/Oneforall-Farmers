...
const LEDGER: LedgerBlock[] = [
  ...
  {
    index: 2,
    action: 'ESCROW_HELD - एस्क्रॉ रक्कम जमा',
...
export function S23_BuyerReliability() {
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.header}>व्यापारी विश्वासार्हता व खातेवही (S23 Ledger View)</Text>

      <Card style={styles.scoreCard}>
        <View style={styles.row}>
          <Text style={styles.scoreTitle}>व्यापारी क्रेडिट स्कोअर</Text>
          <Badge label="९८% वैध (Chain Valid)" type="SUCCESS" />
        </View>
        <Text style={styles.scoreNum}>९८ / १००</Text>
        <Text style={styles.scoreSub}>वेळेवर एस्क्रॉ जमा: १००% (२४/२४ व्यवहार यशस्वी)</Text>
      </Card>

      <Text style={styles.sectionTitle}>अपरिवर्तनीय हॅश साखळी (Immutable Hash Chain):</Text>

      {LEDGER.map(b => (
        <Card key={b.index} style={styles.blockCard}>
          <View style={styles.blockHeader}>
            <Text style={styles.blockIndex}>ब्लॉक #{b.index}</Text>
